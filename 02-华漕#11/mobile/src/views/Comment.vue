    ...
    data: function () {
        return {
            ...
            comParams: {
                ...
                text: '',
                comToName: '',  //给谁回复
                proid: '05fa9423-a2d5-48a9-aa44-1d97f10e8af5',  //项目id，目前是写死的，uuid生成的
                qid: '228c1014-43b3-4f0c-81e5-6395acb3e439',  //二维码id，目前也是写死的，uuid生成的
    ...
    methods: {
        ...
        async weixinIsLogin() {
            ...
            if (res && res.realName) {
                ...
                console.log(this.comParams.key);
                let date = new Date();
