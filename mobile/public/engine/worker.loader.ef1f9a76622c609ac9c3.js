...
/***/ "../src/core/model/loader/worker_loader.js":
/*!*************************************************!*\
  !*** ../src/core/model/loader/worker_loader.js ***!
  \*************************************************/
...
/* harmony import */ var core_utils_fileloader_override__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core/utils/fileloader_override */ "../src/core/utils/fileloader_override.js");
...
self.onmessage = function (msg) {
    ...
    var loader = new core_utils_fileloader_override__WEBPACK_IMPORTED_MODULE_0__.FileLoader();
    loader.setResponseType('arraybuffer');
    loader.setWithCredentials(false);
    var cur = 0;
    loader.load(url, (data, cnt) => {
        cur++;
        self.postMessage({
            type: "loaded",
            url: url,
        ...
        if (cur == cnt) self.postMessage({ type: "done" });
    }, xhr => {
        // ajax下载索引压缩包的进度
        self.postMessage({
            type: "loading",
            url: url, // xhr.target.responseURL,
            download_info: {
                loaded: xhr.loaded,
                total: xhr.total
            }
        ...
        self.postMessage({
            ...
            url: url,
            error: {
                url: err.currentTarget.responseURL,
                status: err.currentTarget.status,
                desc: err.currentTarget.statusText
            }
        });
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, ["engine/three","engine/vendors"], () => (__webpack_require__("../src/core/model/loader/worker_loader.js")))
...
/******/ })()
;
//# sourceMappingURL=worker.loader.ef1f9a76622c609ac9c3.js.map